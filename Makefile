...
all: build
build: $(SRC_DIR)/sort.c $(SRC_DIR)/helper_functions.c $(SRC_DIR)/quicksort.c
	mkdir -p $(BUILD_DIR)/obj $(BUILD_DIR)/release
	$(CC) $(CFLAGS) $(SRC_DIR)/quicksort.c -c -o $(BUILD_DIR)/obj/quicksort.o
	$(CC) $(CFLAGS) $(SRC_DIR)/helper_functions.c $(BUILD_DIR)/obj/quicksort.o -o $(BUILD_DIR)/release/helper_functions
	$(CC) $(CFLAGS) $(SRC_DIR)/sort.c $(BUILD_DIR)/obj/quicksort.o -o $(BUILD_DIR)/release/sort
clean:
	rm -rf $(BUILD_DIR)
debug: $(SRC_DIR)/sort.c $(SRC_DIR)/helper_functions.c $(SRC_DIR)/quicksort.c
	mkdir -p $(BUILD_DIR)/obj $(BUILD_DIR)/debug
	$(CC) $(CDFLAGS) $(SRC_DIR)/quicksort.c -c -o $(BUILD_DIR)/obj/quicksort.o
	$(CC) $(CDFLAGS) $(SRC_DIR)/helper_functions.c $(BUILD_DIR)/obj/quicksort.o -o $(BUILD_DIR)/debug/helper_functions
